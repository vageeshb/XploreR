    ...
    class TravelAgency
    {
        ...
        public void AgencyFunc()//thread function of agency
        {
            ...
            for(int i=0; i<10; i++)
            {
                ...
                if(s==1)//s is similar to semaphore variable. It will be initialized to 0 in hetelsupplier class and is incremented to 1 only when a pricecut event occurs
                {
                    placeorder();
                    s--;
                }
